...
int main(int argc, char **argv) {
    ...
    ///////// Build Map /////////////////////
    CassieData cassie_data(nh, resolution, block_depth, sf2, ell, num_class, free_thresh, occupied_thresh, var_thresh, ds_resolution, free_resolution, max_range, map_topic);
